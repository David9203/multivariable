...
library(stringr)
permanence<-dates[,c(5)] ## Se crea un vector con la salida
permanence
library(stringi)
permanence<-stri_replace_all_fixed(permanence,"Baja",1) ##como hago para tirar dos comandos en una linea?
...
cluster4_FA<-cutree(hier_cluster_FA,k=2)
plot(cluster4_FA)
